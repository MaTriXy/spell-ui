    ...
    <div className="flex flex-col items-center w-full py-12 md:py-24 gap-8 md:gap-16 px-4">
      <div className="flex flex-col items-center text-center gap-6 max-w-[700px]">
        ...
        <div className="flex flex-row gap-3 mt-2 w-auto">
          <RichButton size="lg" className="rounded-full trakcing-tight active:scale-[0.97] will-change-transform ease-out duration-300 px-4.5" asChild>
            <Link href={"/docs/introduction"}>Get Started</Link>
          </RichButton>
          <RichButton size="lg" color="blue" className="shadow-sm shadow-zinc-950/20 group rounded-full [&_svg]:size-4.5 trakcing-tight px-4 active:scale-[0.97] will-change-transform ease-out duration-300" asChild>
