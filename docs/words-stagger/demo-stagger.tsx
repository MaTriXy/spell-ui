  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="space-y-2">
        ...
        <WordsStagger stagger={0.05} className="text-xl font-medium" inView>
      ...
      <div className="space-y-2">
        ...
        <WordsStagger stagger={0.1} className="text-xl font-medium" inView>
          You can just ship things.
        </WordsStagger>
      </div>
      ...
      <div className="space-y-2">
        ...
        <WordsStagger stagger={0.2} className="text-xl font-medium" inView>
          You can just ship things.
        </WordsStagger>
      </div>
    </div>
