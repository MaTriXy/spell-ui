  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="space-y-2">
        ...
        <WordsStagger speed={1} className="text-xl font-medium" inView>
      ...
      <div className="space-y-2">
        ...
        <WordsStagger speed={0.5} className="text-xl font-medium" inView>
          You can just ship things.
        </WordsStagger>
      </div>
      ...
      <div className="space-y-2">
        ...
        <WordsStagger speed={0.3} className="text-xl font-medium" inView>
          You can just ship things.
        </WordsStagger>
      </div>
    </div>
